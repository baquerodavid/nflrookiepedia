        ...
        <div className="py-5 bg-dark text-white" id="teams">
            <div className="container">
                ...
                <div className="row mb-5 mx-0 justify-content-center">
                    <div className="col col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <h3 className="text-center pb-2">AFC NORTE</h3>
                        <ul className="list-unstyled container">
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.baltimoreravens.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={BAL} alt="Logo Baltimore Ravens" width="50" height="50" />
                                    <span className="ms-4">Baltimore Ravens</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.cincinnatibengals.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={CIN} alt="Logo Cincinnati Bengals" width="50" height="50" />
                                    <span className="ms-4">Cincinnati Bengals</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.clevelandbrowns.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={CLE} alt="Logo Cleveland Browns" width="50" height="50" />
                                    <span className="ms-4">Cleveland Browns</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.pittsburghsteelers.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                    ...
                    <div className="col col-md-6 col-lg-3 mb-3 mb-lg-0">
                        ...
                        <ul className="list-unstyled container">
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.buffalobills.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={BUF} alt="Logo Buffalo Bills" width="50" height="50" />
                                    <span className="ms-4">Buffalo Bills</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.miamidolphins.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={MIA} alt="Logo Miami Dolphins" width="50" height="50" />
                                    <span className="ms-4">Miami Dolphins</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.patriots.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={NE} alt="Logo New England Patriots" width="50" height="50" />
                                    <span className="ms-4">New England Patriots</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.newyorkjets.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                    ...
                    <div className="col col-md-6 col-lg-3 mb-3 mb-lg-0">
                        ...
                        <ul className="list-unstyled container">
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.houstontexans.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={HOU} alt="Logo Houston Texans" width="50" height="50" />
                                    <span className="ms-4">Houston Texans</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.colts.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={IND} alt="Logo Indianapolis Colts" width="50" height="50" />
                                    <span className="ms-4">Indianapolis Colts</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.jaguars.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={JAX} alt="Logo Jacksonville Jaguars" width="50" height="50" />
                                    <span className="ms-4">Jacksonville Jaguars</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.tennesseetitans.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                    ...
                    <div className="col col-md-6 col-lg-3 mb-3 mb-lg-0">
                        ...
                        <ul className="list-unstyled container">
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.denverbroncos.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={DEN} alt="Logo Denver Broncos" width="50" height="50" />
                                    <span className="ms-4">Denver Broncos</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.chiefs.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={KC} alt="Logo Kansas City Chiefs" width="50" height="50" />
                                    <span className="ms-4">Kansas City Chiefs</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.raiders.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={LV} alt="Logo Las Vegas Raiders" width="50" height="50" />
                                    <span className="ms-4">Las Vegas Raiders</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="http://www.chargers.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                ...
                <div className="row mx-0 justify-content-center">
                    <div className="col col-md-6 col-lg-3 mb-3 mb-lg-0">
                        ...
                        <ul className="list-unstyled container">
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.chicagobears.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={CHI} alt="Logo Chicago Bears" width="50" height="50" />
                                    <span className="ms-4">Chicago Bears</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.detroitlions.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={DET} alt="Logo Detroit Lions" width="50" height="50" />
                                    <span className="ms-4">Detroit Lions</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.packers.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={GB} alt="Logo Green Bay Packers" width="50" height="50" />
                                    <span className="ms-4">Green Bay Packers</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.vikings.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                    ...
                    <div className="col col-md-6 col-lg-3 mb-3 mb-lg-0">
                        ...
                        <ul className="list-unstyled container">
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.dallascowboys.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={DAL} alt="Logo Dallas Cowboys" width="50" height="50" />
                                    <span className="ms-4">Dallas Cowboys</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.giants.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={NYG} alt="Logo New York Giants" width="50" height="50" />
                                    <span className="ms-4">New York Giants</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.philadelphiaeagles.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={PHI} alt="Logo Philadelphia Eagles" width="50" height="50" />
                                    <span className="ms-4">Philadelphia Eagles</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.commanders.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                    ...
                    <div className="col col-md-6 col-lg-3 mb-3 mb-lg-0">
                        ...
                        <ul className="list-unstyled container">
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.atlantafalcons.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={ATL} alt="Logo Atlanta Falcons" width="50" height="50" />
                                    <span className="ms-4">Atlanta Falcons</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.panthers.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={CAR} alt="Logo Carolina Panthers" width="50" height="50" />
                                    <span className="ms-4">Carolina Panthers</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.neworleanssaints.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={NO} alt="Logo New Orleans Saints" width="50" height="50" />
                                    <span className="ms-4">New Orleans Saints</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.buccaneers.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                    ...
                    <div className="col col-md-6 col-lg-3 mb-3 mb-lg-0">
                        ...
                        <ul className="list-unstyled container">
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.azcardinals.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={ARI} alt="Logo Arizona Cardinals" width="50" height="50" />
                                    <span className="ms-4">Arizona Cardinals</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.therams.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={LA} alt="Logo Los Angeles Rams" width="50" height="50" />
                                    <span className="ms-4">Los Angeles Rams</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.49ers.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
                                    <img src={SF} alt="Logo San Francisco 49ers" width="50" height="50" />
                                    <span className="ms-4">San Francisco 49ers</span>
                                </a>
                            </li>
                            <li className="d-flex align-items-center py-2">
                                <a href="https://www.seahawks.com" className="link-light text-decoration-none link-opacity-75-hover" target="_blank">
